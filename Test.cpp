...
void emulate_logical_or() {
	// define a network with sigmoid activation function and one internal layer with 4 perceptron's
	TinyML::MultiLayeredPerceptron<double> nn({ 2, 4, 1 },
		                                      TinyML::Activation::activation_type::sigmoid );
